...
@IBDesignable open class DNSUIAnimatedField: AnimatedField {
    public typealias ThemeStyle = DNSThemeFieldStyle
    ...
    open func utilityApply(_ style: DNSThemeStyle) {
        ...
        if let style = style as? DNSThemeFieldStyle {
