...
@IBDesignable open class DNSUICircularLabel: DNSUILabel {
    // *******************************************************
    ...
    func centreArcPerpendicular() {
        ...
        for index in 0 ..< length {
            ...
            centre(text: characters[index], context: context, radius: radius, angle: thetaI, slantAngle: thetaI + slantCorrection)
